...
interface MigrationBase {
	 ...
	 * @param source This should be effectively a `ActorSourceGURPS` from the previous version.
	 */
	updateActor?(source: ActorSourceGURPS): Promise<void>
	 ...
	 */
	preUpdateItem?(source: ItemSourceGURPS, actorSource?: ActorSourceGURPS): Promise<void>
	 ...
	 */
	updateItem?(source: ItemSourceGURPS, actorSource?: ActorSourceGURPS): Promise<void>
