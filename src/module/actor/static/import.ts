...
// 	}
//
// 	calcTotalCarried(eqp: (EquipmentSystemSource | EquipmentContainerSystemSource)[]): number {
// 		let t = 0
// 		if (!eqp) return t
// 		for (const i of eqp) {
// 			let w = 0
...
// 	}
//
// 	importTraits(ads: (TraitSystemSource | TraitContainerSystemSource)[]): Record<string, unknown> {
...
// 	importTrait(i: TraitSystemSource | TraitContainerSystemSource | any, p: string): StaticTrait[] {
...
// 	}
//
// 	importSkills(sks: (SkillSystemSource | TechniqueSystemSource)[]): Record<string, unknown> {
// 		if (!sks) return {}
...
// 	// eslint-disable-next-line @typescript-eslint/no-explicit-any
// 	importSk(
// 		i: SkillSystemSource | TechniqueSystemSource | SkillContainerSystemSource | any,
// 		p: string,
// 	): StaticSkill[] {
// 		let name =
...
// 	}
//
// 	importSpells(sps: SpellSystemSource[]): Record<string, unknown> {
// 		if (!sps) return {}
...
//
// 	// eslint-disable-next-line @typescript-eslint/no-explicit-any
// 	importSp(i: SpellSystemSource | SpellContainerSystemSource | any, p: string): StaticSpell[] {
...
//
// 	importEquipment(
// 		eq: (EquipmentSystemSource | EquipmentContainerSystemSource)[],
// 		oeq: (EquipmentSystemSource | EquipmentContainerSystemSource)[],
// 	): Record<string, unknown> {
// 		if (!eq && !oeq) return {}
...
//
// 	importEq(
// 		i: EquipmentSystemSource | EquipmentContainerSystemSource,
// 		p: string,
// 		carried: boolean,
// 	): StaticEquipment[] {
