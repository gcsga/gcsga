...
import { SETTINGS, SYSTEM_NAME, gid } from "@module/data/constants.ts"
import { CharacterImporter, DnD, LocalizeGURPS, PDF, attribute, getNewAttributeId, prepareFormData } from "@util"
...
interface CharacterSheetConfig<TActor extends CharacterGURPS, TOptions extends CharacterSheetConfigOptions>
