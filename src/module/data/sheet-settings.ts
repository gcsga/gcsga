...
class SheetSettings extends foundry.abstract.DataModel<ActorDataModel, SheetSettingsSchema> {
	constructor(
...
interface SheetSettings
	extends foundry.abstract.DataModel<ActorDataModel, SheetSettingsSchema>,
