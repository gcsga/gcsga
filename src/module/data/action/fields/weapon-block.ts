...
class WeaponBlock extends WeaponField<BaseAttack, WeaponBlockSchema> {
...
interface WeaponBlock extends WeaponField<BaseAttack, WeaponBlockSchema>, ModelPropsFromSchema<WeaponBlockSchema> {}
