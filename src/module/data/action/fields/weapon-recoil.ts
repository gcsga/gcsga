...
class WeaponRecoil extends WeaponField<BaseAttack, WeaponRecoilSchema> {
...
interface WeaponRecoil extends WeaponField<BaseAttack, WeaponRecoilSchema>, ModelPropsFromSchema<WeaponRecoilSchema> {}
