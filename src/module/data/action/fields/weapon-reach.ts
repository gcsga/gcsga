...
class WeaponReach extends WeaponField<BaseAttack, WeaponReachSchema> {
...
interface WeaponReach extends WeaponField<BaseAttack, WeaponReachSchema>, ModelPropsFromSchema<WeaponReachSchema> {}
