...
class WeaponBulk extends WeaponField<BaseAttack, WeaponBulkSchema> {
	...
	override resolve(w: BaseAttack, tooltip: TooltipGURPS): WeaponBulk {
...
interface WeaponBulk extends WeaponField<BaseAttack, WeaponBulkSchema>, ModelPropsFromSchema<WeaponBulkSchema> {}
