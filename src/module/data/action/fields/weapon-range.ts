...
class WeaponRange extends WeaponField<BaseAttack, WeaponRangeSchema> {
...
interface WeaponRange extends WeaponField<BaseAttack, WeaponRangeSchema>, ModelPropsFromSchema<WeaponRangeSchema> {}
