...
import { AncestryOptions, WeightedAncestryOptions } from "./components/ancestry-options.ts"
...
class AncestryData extends SystemDataModel<JournalEntryPage<JournalEntry>, AncestrySchema> {
	static override defineSchema(): AncestrySchema {
		...
		return {
			...
			gender_options: new fields.ArrayField(new fields.EmbeddedDataField(WeightedAncestryOptions)),
		}
	}
}
...
type AncestrySchema = {
	...
	gender_options: fields.ArrayField<fields.EmbeddedDataField<WeightedAncestryOptions>>
}
