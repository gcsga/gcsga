...
// import * as MookAttributes from "./mook/attributes.ts"
// import * as MookTraits from "./mook/traits.ts"
// import * as MookSkills from "./mook/skills.ts"
...
export function registerQuenchBatches(quench: Quench): void {
	...
	// 	MookSpells.registerBatches(quench)
	// 	MookAttacks.registerBatches(quench)
}
