import { MoveTypeResolver, sanitizeId } from "@util"
import { MoveTypeObj } from "./data.ts"
import { MoveTypeDef } from "./move-type-def.ts"
import { MoveBonusType, reserved_ids } from "@system"

export class MoveType {
	actor: MoveTypeResolver
	...
	constructor(actor: MoveTypeResolver, move_type_id: string, order: number, data?: Partial<MoveTypeObj>) {
