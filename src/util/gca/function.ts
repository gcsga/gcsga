...
export type eFunction = (e: EvaluatorGCA, a: string) => unknown

/**
 *
 */
export function evalFunctionsGCA(): Map<string, eFunction> {
	const m = new Map()
	...
	m.set("@max", evalMaximumGCA)
	m.set("@min", evalMinimumGCA)
...
// function evalAbsolute(e: EvaluatorGCA, args: string): number {
...
//  * @param args
//  */
// function evalCubeRoot(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalCeiling(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalBaseEExpontential(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalBase2Expontential(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
// 	return 2 ** value
// }
//
...
//  * @param args
//  */
// function evalFloor(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
 ...
 * @param args
 */
function evalIfGCA(e: EvaluatorGCA, args: string): boolean {
	args = args.replace("THEN", ",")
	args = args.replace("ELSE", ",")
	let arg: string
 ...
 * @param args
 */
function evalMinimumGCA(e: EvaluatorGCA, args: string): number {
...
// function evalNaturalLog(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
// 	return Math.log(value)
// }
//
// function evalNaturalLogSum(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalDecimalLog(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalRound(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalSqrt(e: EvaluatorGCA, args: string): number {
// 	const value = evalToNumber(e, args)
...
//  * @param args
//  */
// function evalDice(e: EvaluatorGCA, args: string): string {
...
//  * @param a
//  */
// function evalRoll(e: EvaluatorGCA, a: string): number {
// 	if (a.indexOf("(") !== -1) {
// 		a = evalToString(e, a)
// 	}
...
//  * @param a
//  */
// function evalToBool(e: EvaluatorGCA, a: string): boolean {
...
//  * @param a
//  */
// function evalSigned(e: EvaluatorGCA, a: string): string {
...
//  * @param arg
//  */
// function evalSkillLevel(e: EvaluatorGCA, arg: string): number {
...
function evalToNumber(e: EvaluatorGCA, arg: string): number {
	const evaluated = e.evaluateNew(arg)
...
//  * @param a
//  */
// export function evalToString(e: EvaluatorGCA, a: string): string {
...
// }
//
// export function evalEncumbrance(e: EvaluatorGCA, a: string): number {
...
// }
//
// export function evalHasTrait(e: EvaluatorGCA, a: string): boolean {
...
// }
//
// export function evalTraitLevel(e: EvaluatorGCA, a: string): number {
// 	const entity: CharacterResolver | undefined = e.resolver as CharacterResolver
// 	if (!entity) return -1
// 	const arg = a.replaceAll(/^['"]|[']$/g, "")
// 	let levels = -1
...
// }
//
// export function evalSSRT(e: EvaluatorGCA, a: string): number {
// 	let arg: string
// 	;[arg, a] = nextArg(a)
...
// }
//
// export function evalSSRTYards(e: EvaluatorGCA, a: string): number {
...
// }
//
// export function evalRandomHeight(e: EvaluatorGCA, a: string): number {
// 	const entity: CharacterResolver | undefined = e.resolver as CharacterResolver
// 	if (!entity) return -1
...
// }
//
// export function evalRandomWeight(e: EvaluatorGCA, a: string): number | null {
// 	const entity: CharacterResolver | undefined = e.resolver as CharacterResolver
// 	if (!entity) return -1
// 	let arg: string
// 	;[arg, a] = nextArg(a)
